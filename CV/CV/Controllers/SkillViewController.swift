...
class SkillViewController: UIViewController {
    ...
    let customSkills: [customSkill] = [customSkill.init(skill: "C++ programming", category: "Hard skills"), customSkill.init(skill: "Swift programming", category: "Hard skills"), customSkill.init(skill: "CoreData skills", category: "Hard skills"), customSkill.init(skill: "SpriteKit skills", category: "Hard skills"), customSkill.init(skill: "iOS programming", category: "Hard skills"), customSkill.init(skill: "Analytical thinking", category: "Soft skills"), customSkill.init(skill: "Punctuality", category: "Soft skills"), customSkill.init(skill: "Creativity", category: "Soft skills"), customSkill.init(skill: "Desire to learn", category: "Soft skills"), customSkill.init(skill: "TeamWork", category: "Soft skills"), customSkill.init(skill: "English", category: "Languages"), customSkill.init(skill: "Ukrainian", category: "Languages"), customSkill.init(skill: "Russian", category: "Languages")]
